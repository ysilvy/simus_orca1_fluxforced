...
#  include "domzgr_substitute.h90"
   ...
   !! $Id: sbcssm.F90 5407 2015-06-11 19:13:22Z smasson $
   ...
   SUBROUTINE sbc_ssm( kt )
      ...
      ELSE
         ...
         IF( lrst_oce ) THEN                              !      Write in the ocean restart file     !
            ...
            CALL iom_rstput( kt, nitrst, numrow, 'qfrz_m'  , qfrz_m  ) !Yona
            !
         ENDIF
         !
      ENDIF
   ...
   SUBROUTINE sbc_ssm_init
      ...
      ELSE
         ...
         IF( ln_rstart .AND. iom_varid( numror, 'nn_fsbc', ldstop = .FALSE. ) > 0 ) THEN
            ...
            ENDIF
            !Yona
            IF( iom_varid( numror, 'qfrz_m', ldstop = .FALSE. ) > 0 ) THEN
               CALL iom_get( numror, jpdom_autoglo, 'qfrz_m'  , qfrz_m  )
            ELSE
               qfrz_m(:,:) = 0._wp   ! default definition
            ENDIF
            !Yona
            !
