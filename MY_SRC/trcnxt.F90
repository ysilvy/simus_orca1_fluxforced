...
CONTAINS
   ...
   SUBROUTINE trc_nxt( kt )
      ...
      INTEGER ::  ii0, ii1, ij0, ij1   ! dummy loop index !Yona
      ...
      !Yona set PAS to 34.7 in a box in the Arctic 
      ii0 = 208    ;   ii1 = 222
      ij0 = 319    ;   ij1 = 329
      tra( mi0(ii0):mi1(ii1) , mj0(ij0):mj1(ij1),:,jp_myt1 ) =  34.7 !PAS
      tra( mi0(ii0):mi1(ii1) , mj0(ij0):mj1(ij1),:,jp_myt0 ) =  0. !PAT
      !Yona
