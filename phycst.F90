MODULE phycst
   ...
   REAL(wp), PUBLIC ::   rcpic    =    1.895439e+6_wp  !: volumetric specific heat for ice                      [J/m3/K]
   ...
   REAL(wp), PUBLIC ::   xlsn     =  110.22e+6_wp   !: volumetric latent heat fusion of snow                 [J/m3]
...
#endif
   REAL(wp), PUBLIC ::   lfusisf  = 0.334e6_wp    ! phycst ?
   !!----------------------------------------------------------------------
   !! NEMO/OPA 3.3 , NEMO Consortium (2010)
   !! $Id: phycst.F90 7537 2017-01-10 11:09:30Z vancop $ 
