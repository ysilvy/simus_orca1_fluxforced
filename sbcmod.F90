...
CONTAINS
   ...
   SUBROUTINE sbc_init
      ...
      !!
      NAMELIST/namsbc/ nn_fsbc   , ln_ana    , ln_flx, ln_flx_ano, ln_blk_clio, ln_blk_core, ln_mixcpl,   & !Yona added
...
902   IF( ios /= 0 ) CALL ctl_nam ( ios , 'namsbc in configuration namelist', lwp )
      ...
      IF(lwp) THEN               ! Control print
         ...
         WRITE(numout,*) '              flux       formulation perturbation (Yona) ln_flx_ano  = ', ln_flx_ano !Yona
